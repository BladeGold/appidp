...
<div class="container">
    <section class="content">
        <div class="container-fluid">
            ...
            @if($esMiembro == true)
            @foreach($iglesia as $id => $value)
        <div class="card border-primary mb-3" >
            <div class="card-header">Usted es Miembro en <strong> Iglesia de Dios de la Profecía en {{$value}} </strong></div>
            @endforeach
